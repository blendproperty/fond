...
const base:QueueOrder={status:'received',fulfillment:'collection',posRecordedAt:null,posRequired:true,createdAt,updatedAt:createdAt,totalCents:9500,payment:{paidCents:0,checkout:null}};
